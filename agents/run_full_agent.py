"""
Thin wrapper: run the FULL coopetition pipeline (variant "full") for one ticker.

Equivalent to a one-ticker experiment with a single `mode: leader` system
(all three sub-task agents + the red-team rebuttal loop, cap 3). All wiring
lives in the experiment harness (experiments/); for the three-way ablation or
